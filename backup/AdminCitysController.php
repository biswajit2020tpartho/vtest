<?php namespace App\Http\Controllers;
	...
	class AdminCitysController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			// $this->form = [];
			// $this->form[] = ['label'=>'State Name','name'=>'state_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'states,state_name'];
