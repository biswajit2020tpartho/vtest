<?php namespace App\Http\Controllers;
	...
	class AdminStatesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Country Name","name"=>"country_id","join"=>"country,name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Country Name','name'=>'country_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'country,name'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Country Id","name"=>"country_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"country,name"];
