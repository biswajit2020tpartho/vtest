<?php namespace App\Http\Controllers;
	...
	class AdminVenCurrencyController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "ven_currency";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			// $this->col[] = ["label"=>"Currency Id","name"=>"id","join"=>"ven_currency,id"];
			$this->col[] = ["label"=>"Title","name"=>"title"];
			$this->col[] = ["label"=>"Code","name"=>"code"];
			$this->col[] = ["label"=>"Symbol","name"=>"symbol"];
			...
			$this->form = [];
			// $this->form[] = ['label'=>'Currency Id','name'=>'id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'ven_currency,id'];
			...
			$this->form[] = ['label'=>'Symbol','name'=>'symbol','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = [
				'label'=>'Value',
				'name'=>'value',
				'type'=>'text',
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Currency Id","name"=>"id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"currency,id"];
			...
			//$this->form[] = ["label"=>"Symbol","name"=>"symbol","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Value","name"=>"value","type"=>"money","required"=>TRUE,"validation"=>"required|integer|min:0"];
