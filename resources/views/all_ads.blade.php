...
<section class="bannercontainer">
  ...
  <div class="bannerinnercontent">
    @if($categoryDetails->model == "App\Models\State")
    <h1>{{ $categoryDetails->resource->state_name}}</h1>
    @elseif($categoryDetails->model == "App\Models\Categorie")
     <h1>{{ $categoryDetails->resource->name}}</h1>
    @else
    <h1>@lang('all_ads.all_ads')</h1>
    @endif
  </div>
</section>
                ...
                <div id="collapseThree" class="filterbxbody collapse in show" role="tabpanel" aria-expanded="true">
                  <div class="filterbxbodyinner pt-1 pb-0">
                    <div class="searchbxfilter">
                      <input type="text" class="form-control" placeholder="@lang('all_ads.search_state')" name="search_state" id="search_state">
        ...
        <div class="prolistouter">
          <div class="listingbreadcrumb">
            <ol class="breadcrumb">
              ...
              @if($categoryDetails->model == "App\Models\State")
              <li class="active">{{ $categoryDetails->resource->state_name}}</li>
              @elseif($categoryDetails->model == "App\Models\Categorie")
              <li class="active">{{ $categoryDetails->resource->name}}</li>
              @else
              <li class="active">@lang('all_ads.all_ads')</li>
              @endif
            </ol>
          </div>
          <div id="all_ads">
