<?php namespace App\Http\Controllers;
	...
	class AdminCitysController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"State Name","name"=>"state_id","join"=>"states,state_name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'State','name'=>'state_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'states,state_name'];
			$this->form[] = ['label'=>'City Name','name'=>'city_name','type'=>'text','validation'=>'required|min:1|max:255|unique:citys','width'=>'col-sm-10'];
			$this->form[] = [
				'label'=>'Status',
				'name'=>'status',
				'type'=>'select',
