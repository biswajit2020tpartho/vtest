<?php namespace App\Http\Controllers;
	...
	class AdminSubcategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Category','name'=>'parent_id','type'=>'select2','validation'=>'required|min:1|max:255|unique:categories','width'=>'col-sm-10','datatable'=>'categories,name'];

			$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','width'=>'col-sm-10','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
