<?php namespace App\Http\Controllers;
	...
	class AdminCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'required|string|min:3|max:70|unique:categories','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
