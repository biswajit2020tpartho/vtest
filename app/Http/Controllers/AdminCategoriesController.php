<?php namespace App\Http\Controllers;
	...
	class AdminCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->col[] = array("label"=>"Parent Id","name"=>"parent_id","join"=>"parent,id");
		$this->col[] = array("label"=>"Image","name"=>"image" ,"image"=>true);
		$this->col[] = array("label"=>"Short Description","name"=>"short_description" );
		$this->col[] = array("label"=>"Description","name"=>"description" );
		$this->col[] = array("label"=>"Is Feature","name"=>"is_feature" );
