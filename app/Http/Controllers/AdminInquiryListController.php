<?php namespace App\Http\Controllers;
	...
	class AdminInquiryListController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:inquiry_table","placeholder"=>"Please enter a valid email address"];
