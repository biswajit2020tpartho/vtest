<?php namespace App\Http\Controllers;
	...
	class AdminUsermanagementController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->form[] = ['label'=>'Status','name'=>'status','type'=>'select','validation'=>'required|min:1|max:255','dataenum'=>'Active|Active;Inactive|Inactive'];
	        ...
	        */
	        ...
	        $this->sub_module[] = ['label'=>'Advertisements','path'=>'advertisements','parent_columns'=>'name','foreign_key'=>'user_id','button_color'=>'primary','button_icon'=>'fa fa-bars'];
	        $this->sub_module[] = ['label'=>'Subscription','path'=>'packages_subscriptions','parent_columns'=>'name','foreign_key'=>'user_id','button_color'=>'primary','button_icon'=>'fa fa-calendar'];
